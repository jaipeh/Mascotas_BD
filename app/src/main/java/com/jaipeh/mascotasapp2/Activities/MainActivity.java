...
import com.jaipeh.mascotasapp2.Adapters.PageAdapter;
import com.jaipeh.mascotasapp2.Clases.Mascota;
import com.jaipeh.mascotasapp2.Fragments.MascotaListFragment;
import com.jaipeh.mascotasapp2.Fragments.MascotaPerfilFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null) {
            toolbar.setNavigationIcon(R.drawable.ic_mascota);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_acerca) {
            ...
            dialogo_acerca.setIcon(R.drawable.ic_mascota);
        ...
        if (id == R.id.action_five_mascota) {
